...
export interface ApiAdsManagementAdsManagement extends Struct.SingleTypeSchema {
  collectionName: 'ads_managements';
  info: {
    description: 'Manage banner advertisements across the site';
    displayName: 'Ads Management';
    pluralName: 'ads-managements';
    singularName: 'ads-management';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    articleBanner: Schema.Attribute.Media<'images'>;
    articleBannerLink: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headerBanner: Schema.Attribute.Media<'images'>;
    headerBannerLink: Schema.Attribute.String;
    homeSecondBanner: Schema.Attribute.Media<'images'>;
    homeSecondBannerLink: Schema.Attribute.String;
    homeSidebarBanner: Schema.Attribute.Media<'images'>;
    homeSidebarBannerLink: Schema.Attribute.String;
    homeTopBanner: Schema.Attribute.Media<'images'>;
    homeTopBannerLink: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ads-management.ads-management'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bio: Schema.Attribute.Text &
      ...
      Schema.Attribute.DefaultTo<'\u09B8\u09A4\u09CD\u09AF\u09A7\u09BE\u09B0\u09BE \u09AA\u09CD\u09B0\u09A4\u09BF\u09A6\u09BF\u09A8\u09C7\u09B0 \u0985\u09AB\u09BF\u09B8\u09BF\u09AF\u09BC\u09BE\u09B2 \u09A8\u09BF\u0989\u099C \u09A1\u09C7\u09B8\u09CD\u0995\u0964'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    role: Schema.Attribute.Enumeration<
      ['editorial', 'staff', 'bureau', 'guest', 'agency']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    Slug: Schema.Attribute.UID<'display_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Details for the Contact Page';
    displayName: 'Contact';
    pluralName: 'contacts';
  ...
  attributes: {
    ...
    contactMapLat: Schema.Attribute.Float &
      Schema.Attribute.DefaultTo<23.8103968>;
    contactMapLng: Schema.Attribute.Float &
      Schema.Attribute.DefaultTo<90.41256666>;
    ...
    formWebsiteLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEpaperEpaper extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zones: Schema.Attribute.Component<'epaper.zone', true>;
  };
}
...
export interface ApiFaqFaq extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'FAQ page content with header image and list of FAQ items';
    displayName: 'FAQ';
    pluralName: 'faqs';
    singularName: 'faq';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqHeaderImage: Schema.Attribute.Media<'images'>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    appQrImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    editorialAddress1: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialAddress2: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialEditor: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialEmail: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialName: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialOffice: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialPhone: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    editorialPublisher: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    menu: Schema.Attribute.Component<'navigation.base-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    socialFacebookFans: Schema.Attribute.Integer &
    ...
    socialRssSubscribers: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    socialRssUrl: Schema.Attribute.String;
    socialTotalFollowers: Schema.Attribute.BigInteger &
      Schema.Attribute.DefaultTo<0>;
    socialTwitterFollowers: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    socialTwitterUrl: Schema.Attribute.String;
    socialYoutubeSubscribers: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
...
export interface ApiHeaderTopHeaderTop extends Struct.SingleTypeSchema {
  collectionName: 'header_tops';
  info: {
    description: 'Top-most navigation and social links';
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showTrendingLimit: Schema.Attribute.Integer;
    tickerSpeed: Schema.Attribute.Integer;
    trendingSectionTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLatestVideoNewsLatestVideoNews
  extends Struct.CollectionTypeSchema {
  collectionName: 'latest_ytvideo_news';
  info: {
    displayName: 'Latest Video News';
    pluralName: 'latest-ytvideo-news';
    singularName: 'latest-video-news';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::latest-video-news.latest-video-news'
    >;
...
export interface ApiPollPoll extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Polls for user voting';
    displayName: 'Poll';
    pluralName: 'polls';
    singularName: 'poll';
  };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tags used for article grouping';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ads-management.ads-management': ApiAdsManagementAdsManagement;
